...
;--- macros ---;
;--------------;
; syscall macros for me and your eyes :3    
...
next_cell:               ; increment brainfuck tape pointer and go to the first cell if current cell is max
  cmp r14, r13
  jge .to_first_cell
  inc r14
  jmp mainloop
...
prev_cell:              ; decrement brainfuck tape pointer and go to the max cell if current cell is first
  cmp r14, r12
  jle .to_max_cell
  dec r14
  jmp mainloop

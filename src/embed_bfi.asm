...
macro SYSCALL_3 num, arg1, arg2, arg3 { 	; syscall macros for me and your eyes :3
mov rdi, arg1
mov rsi, arg2
mov rdx, arg3
mov rax, num
...
SYS_EXIT = 60 		; constants

BF_TAPE_SIZE = 30000
BF_FIRST_CELL_PTR = bf_tape + 0
BF_MAX_CELL_PTR = bf_tape + 29999
BF_CODE_SIZE = 20000
...
next_cell:		; increment bf_code pointer
  cmp r14, BF_MAX_CELL_PTR
  je .to_first_cell
  inc r14
  jmp mainloop

.to_first_cell:
  mov r14, BF_FIRST_CELL_PTR
  jmp mainloop


prev_cell:		; decrement bf_code pointer
  cmp r14, BF_FIRST_CELL_PTR
  je .to_max_cell
  dec r14
  jmp mainloop

.to_max_cell:
  mov r14, BF_MAX_CELL_PTR
  jmp mainloop
...
bf_loop_end:		; jump to r15 from stack and skip if cell = 0
  cmp byte [r14], 0
  je mainloop
  pop r15
  dec r15
...
bf_tape db BF_TAPE_SIZE dup(0)
bf_code db 20000 dup(0xBF) 		; BF = brainfuck :)
